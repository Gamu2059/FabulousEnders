public class FEConst {
    ...
    // AIの行動ID
    public static final int BATTLE_AI_NO_MARK = -7400;
    public static final int BATTLE_AI_UNIT = -7401;
    public static final int BATTLE_AI_IMPORTANCE = -7402;
    public static final int BATTLE_AI_NO_MOVE = -7403;
    public static final int BATTLE_AI_GO_POSITION = -7404;

    //////////////////////////////////////////////////////
    // Over All
    //////////////////////////////////////////////////////
    // ゲーム全体のモード
    public static final int OVERALL_MODE_TITLE = -100000;
    public static final int OVERALL_MODE_TALK = -100001;
    public static final int OVERALL_MODE_BASE = -100002;
    public static final int OVERALL_MODE_PRE_SORTIE = -100003;
    public static final int OVERALL_MODE_SORTIE = -100004;
    public static final int OVERALL_MODE_GAME_CLEAR = -100005;
    public static final int OVERALL_MODE_GAME_OVER = -100006;
}